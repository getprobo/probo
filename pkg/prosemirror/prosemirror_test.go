...
func TestUnmarshalDocument(t *testing.T) {
	...
	t.Run("paragraph with mixed marks", func(t *testing.T) {
		t.Parallel()
		p := doc.Content[1]
	...
	t.Run("heading level 3", func(t *testing.T) {
		t.Parallel()
		h3 := doc.Content[5]
	...
	t.Run("trailing empty paragraph", func(t *testing.T) {
		t.Parallel()
...
func TestCodeBlockAttrs(t *testing.T) {
	...
	t.Run("with null language", func(t *testing.T) {
		t.Parallel()
...
func TestTableCellAttrs(t *testing.T) {
	...
	t.Run("with colwidth", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("with null colwidth", func(t *testing.T) {
		t.Parallel()
