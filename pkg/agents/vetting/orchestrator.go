...
var orchestratorBasePrompt string

//go:embed default_procedure.txt
var defaultProcedure string
...
func newOrchestratorAgent(
	...
	readOnlyBrowserTools, err := browser.BuildReadOnlyTools(vendorBrowser)
	if err != nil {
	...
	unrestrictedBrowserTools, err := browser.BuildTools(researchBrowser)
	if err != nil {
	...
	if searchEndpoint != "" {
		researchBrowserTools, err := browser.BuildTools(researchBrowser)
		if err != nil {
