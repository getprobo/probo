...
|---|---:|---:|
| Required Rust + JavaScript boundary behavior | 194 | 168 |
...
|---|---:|---|
| `rust/tests/test.rs` | 14 | patch-log misuse, transactions and isolation, reverse-diff patches, large list patches, iterators, and regression corpus |
...
Total required pending entries: **168**.
