...
|---|---:|---:|
| Required Rust + JavaScript boundary behavior | 131 | 231 |
...
|---|---:|---|
| `rust/tests/test.rs` | 41 | conflict type changes, nested conflicts, counters, list causality, complex save/load, patch-log misuse, isolation, historical marks, and regression corpus |
...
Total required pending entries: **231**.
