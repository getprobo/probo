...
|---|---:|---:|
| Required Rust + JavaScript boundary behavior | 147 | 215 |
...
|---|---:|---|
| `rust/tests/test.rs` | 25 | list-index counter conflicts, patch-log misuse, transactions and isolation, historical marks, reverse-diff patches, large list patches, iterators, and regression corpus |
...
| `rust/tests/test_save_load_orphans.rs` | 3 | preserving or discarding orphan changes and rejecting missing incremental dependencies |
...
Total required pending entries: **215**.
