...
type (
	...
	StateOfApplicabilities []*StateOfApplicability
...
func (s *StateOfApplicabilities) LoadByOrganizationID(
	ctx context.Context,
	conn pg.Conn,
	scope Scoper,
...
`
	...
	stateOfApplicabilities, err := pgx.CollectRows(rows, pgx.RowToAddrOfStructByName[StateOfApplicability])
	if err != nil {
		return fmt.Errorf("cannot collect states_of_applicability: %w", err)
	}

	*s = stateOfApplicabilities
	return nil
}

func (s *StateOfApplicabilities) CountByOrganizationID(
	ctx context.Context,
	conn pg.Conn,
	scope Scoper,
	organizationID gid.GID,
...
func (soas StateOfApplicabilities) Snapshot(ctx context.Context, conn pg.Conn, scope Scoper, organizationID, snapshotID gid.GID) error {
...
func (soas StateOfApplicabilities) insertStateOfApplicabilitySnapshots(
	ctx context.Context,
	conn pg.Conn,
	scope Scoper,
	organizationID gid.GID,
...
func (soas StateOfApplicabilities) insertStateOfApplicabilityControlSnapshots(
	ctx context.Context,
	conn pg.Conn,
	scope Scoper,
	organizationID gid.GID,
