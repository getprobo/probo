...
func (st *RiskAssessmentScenarioThreat) Insert(ctx context.Context, conn pg.Tx, predicate Predicater) error {
	q := `
...
func (st *RiskAssessmentScenarioThreat) Delete(ctx context.Context, conn pg.Tx, predicate Predicater) error {
	q := `
