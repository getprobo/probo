...
const (
	...
	// Deprecated: kept for DB enum compatibility and migration safety.
	AccessEntryDecisionModify AccessEntryDecision = "MODIFY"
)
...
func (d *AccessEntryDecision) Scan(value any) error {
	...
	case []byte:
		str = string(v)
	default:
		return fmt.Errorf("unsupported type for AccessEntryDecision: %T", value)
	}
	...
	case "MODIFY":
		*d = AccessEntryDecisionModify
	default:
		return fmt.Errorf("invalid AccessEntryDecision value: %q", str)
	}
	return nil
}
