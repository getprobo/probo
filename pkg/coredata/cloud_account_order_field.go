...
const (
	CloudAccountOrderFieldCreatedAt CloudAccountOrderField = "CREATED_AT"
	CloudAccountOrderFieldStatus    CloudAccountOrderField = "STATUS"
...
func (f CloudAccountOrderField) MarshalText() ([]byte, error) {
