...
func TestEvidenceAssessmentStatusIsValid(t *testing.T) {
	t.Parallel()

	for _, value := range EvidenceAssessmentStatuses() {
		if !value.IsValid() {
			t.Fatalf("IsValid() = false for %q", value)
		}
	}

	if EvidenceAssessmentStatus("BOGUS").IsValid() {
		t.Fatal("IsValid() = true for invalid value")
	}
}

func TestEvidenceAssessmentStatusUnmarshalText(t *testing.T) {
	t.Parallel()
	...
	for _, value := range EvidenceAssessmentStatuses() {
		t.Run(string(value), func(t *testing.T) {
			...
			var got EvidenceAssessmentStatus
...
func TestEvidenceAssessmentStatusMarshalText(t *testing.T) {
	t.Parallel()
