...
func (t *RiskAssessmentThreat) LoadByID(ctx context.Context, conn pg.Querier, predicate Predicater, id gid.GID) error {
	q := `
SELECT
	id,
	organization_id,
...
func (t *RiskAssessmentThreat) Insert(ctx context.Context, conn pg.Tx, predicate Predicater) error {
	q := `
...
func (t *RiskAssessmentThreat) Update(ctx context.Context, conn pg.Tx, predicate Predicater) error {
	q := `
...
func (t *RiskAssessmentThreat) Delete(ctx context.Context, conn pg.Tx, predicate Predicater, id gid.GID) error {
	q := `
