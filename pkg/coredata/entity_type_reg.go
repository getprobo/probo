...
var EntityTypes = map[uint16]string{
	OrganizationEntityType:                     "Organization",
	FrameworkEntityType:                        "Framework",
	MeasureEntityType:                          "Measure",
	TaskEntityType:                             "Task",
	EvidenceEntityType:                         "Evidence",
	ConnectorEntityType:                        "Connector",
	VendorRiskAssessmentEntityType:             "VendorRiskAssessment",
	VendorEntityType:                           "Vendor",
	PeopleEntityType:                           "People",
	VendorComplianceReportEntityType:           "VendorComplianceReport",
	DocumentEntityType:                         "Document",
	UserEntityType:                             "User",
	SessionEntityType:                          "Session",
	EmailEntityType:                            "Email",
	ControlEntityType:                          "Control",
	RiskEntityType:                             "Risk",
	DocumentVersionEntityType:                  "DocumentVersion",
	DocumentVersionSignatureEntityType:         "DocumentVersionSignature",
	AssetEntityType:                            "Asset",
	DatumEntityType:                            "Datum",
	AuditEntityType:                            "Audit",
	ReportEntityType:                           "Report",
	TrustCenterEntityType:                      "TrustCenter",
	TrustCenterAccessEntityType:                "TrustCenterAccess",
	VendorBusinessAssociateAgreementEntityType: "VendorBusinessAssociateAgreement",
	FileEntityType:                             "File",
	VendorContactEntityType:                    "VendorContact",
	VendorDataPrivacyAgreementEntityType:       "VendorDataPrivacyAgreement",
	NonconformityEntityType:                    "Nonconformity",
	ObligationEntityType:                       "Obligation",
	VendorServiceEntityType:                    "VendorService",
	SnapshotEntityType:                         "Snapshot",
	ContinualImprovementEntityType:             "ContinualImprovement",
	ProcessingActivityEntityType:               "ProcessingActivity",
	ExportJobEntityType:                        "ExportJob",
	TrustCenterReferenceEntityType:             "TrustCenterReference",
	TrustCenterDocumentAccessEntityType:        "TrustCenterDocumentAccess",
	CustomDomainEntityType:                     "CustomDomain",
	InvitationEntityType:                       "Invitation",
	MembershipEntityType:                       "Membership",
	SlackMessageEntityType:                     "SlackMessage",
	TrustCenterFileEntityType:                  "TrustCenterFile",
	SAMLConfigurationEntityType:                "SAMLConfiguration",
	UserAPIKeyEntityType:                       "UserAPIKey",
	UserAPIKeyMembershipEntityType:             "UserAPIKeyMembership",
}
