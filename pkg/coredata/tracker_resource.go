...
`
	...
	q = fmt.Sprintf(q, predicate.SQLFragment(), predicate.SQLFragment(), filter.SQLFragment(), cursor.SQLFragment())
...
`
	...
	q = fmt.Sprintf(q, predicate.SQLFragment(), predicate.SQLFragment(), filter.SQLFragment())
