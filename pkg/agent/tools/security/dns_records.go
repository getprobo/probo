...
func CheckDNSRecordsTool() (agent.Tool, error) {
	return agent.FunctionTool[dnsRecordsParams](
		"check_dns_records",
...
func queryDNS(ctx context.Context, client *dns.Client, question dns.RR) ([]dns.RR, error) {
	msg := &dns.Msg{
