...
func (s *GeneratedDocumentService) PublishStatementOfApplicability(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			if err := soa.LoadByID(ctx, tx, predicate, statementOfApplicabilityID); err != nil {
				return fmt.Errorf("cannot load statement of applicability: %w", err)
			}

			documentData, err := s.buildStatementOfApplicabilityDocumentData(ctx, predicate, tx, soa)
			if err != nil {
			...
			if soa.DocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *soa.DocumentID)
				...
				if err == nil && doc.ArchivedAt == nil {
					...
					soa.UpdatedAt = now
					if err := soa.Update(ctx, tx, predicate); err != nil {
			...
			return s.publishOrRequestApproval(ctx, predicate, tx, document, documentVersion, soa.OrganizationID, approverIDs, minor, now)
		},
	)
	if err != nil {
		return nil, nil, err
...
func (s *GeneratedDocumentService) buildStatementOfApplicabilityDocumentData(
	...
	if err := organization.LoadByID(ctx, conn, predicate, statementOfApplicability.OrganizationID); err != nil {
	...
	if err := applicabilityStatements.LoadAllByStatementOfApplicabilityID(ctx, conn, predicate, statementOfApplicability.ID); err != nil {
	...
	if err := controls.LoadByIDs(ctx, conn, predicate, controlIDs); err != nil {
	...
	controlOblTypes, err := coredata.LoadObligationTypesByControlIDs(ctx, conn, predicate, controlIDs)
	if err != nil {
	...
	if err := controlsWithRisk.LoadByControlIDs(ctx, conn, predicate, controlIDs); err != nil {
...
func (s *GeneratedDocumentService) PublishDataList(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			documentData, err := s.buildDataListDocumentData(ctx, predicate, tx, organization)
			if err != nil {
				return fmt.Errorf("cannot build document data: %w", err)
			}
			...
			if dataDocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *dataDocumentID)
				if err != nil && !errors.Is(err, coredata.ErrResourceNotFound) {
			...
			if existingDoc == nil {
				...
				if err := datum.UpsertGeneratedDocumentID(ctx, tx, organizationID, predicate.GetTenantID(), documentID); err != nil {
			...
			return s.publishOrRequestApproval(ctx, predicate, tx, document, documentVersion, organizationID, approverIDs, minor, now)
		},
	)
	if err != nil {
		return nil, nil, err
...
func (s *GeneratedDocumentService) buildDataListDocumentData(
	...
	if err := data.LoadAllByOrganizationID(ctx, conn, predicate, organization.ID); err != nil {
	...
	if err := profiles.LoadByIDs(ctx, conn, predicate, ownerIDs); err != nil {
	...
	for _, d := range data {
		...
		if err := thirdParties.LoadAllByDatumID(ctx, conn, predicate, d.ID); err != nil {
...
func (s *GeneratedDocumentService) PublishAssetList(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			documentData, err := s.buildAssetListDocumentData(ctx, predicate, tx, organization)
			if err != nil {
				return fmt.Errorf("cannot build document data: %w", err)
			}
			...
			if assetDocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *assetDocumentID)
				if err != nil && !errors.Is(err, coredata.ErrResourceNotFound) {
			...
			if existingDoc == nil {
				...
				if err := asset.UpsertGeneratedDocumentID(ctx, tx, organizationID, predicate.GetTenantID(), documentID); err != nil {
					return fmt.Errorf("cannot upsert generated documents: %w", err)
				}
			} else {
				document = existingDoc
...
func (s *GeneratedDocumentService) buildAssetListDocumentData(
	...
	if err := assets.LoadAllByOrganizationID(ctx, conn, predicate, organization.ID); err != nil {
	...
	for _, a := range assets {
		...
		var thirdParties coredata.ThirdParties
		if err := thirdParties.LoadAllByAssetID(ctx, conn, predicate, a.ID); err != nil {
...
func (s *GeneratedDocumentService) PublishFindingList(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			documentData, err := s.buildFindingListDocumentData(ctx, predicate, tx, organization)
			if err != nil {
				return fmt.Errorf("cannot build document data: %w", err)
			}
			...
			if findingDocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *findingDocumentID)
				if err != nil && !errors.Is(err, coredata.ErrResourceNotFound) {
			...
			if existingDoc == nil {
				...
				if err := finding.UpsertGeneratedDocumentID(ctx, tx, organizationID, predicate.GetTenantID(), documentID); err != nil {
					return fmt.Errorf("cannot upsert generated documents: %w", err)
				}
			} else {
				document = existingDoc
...
func (s *GeneratedDocumentService) buildFindingListDocumentData(
	...
	if err := findings.LoadAllByOrganizationID(ctx, conn, predicate, organization.ID); err != nil {
...
func (s *GeneratedDocumentService) PublishObligationList(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			documentData, err := s.buildObligationListDocumentData(ctx, predicate, tx, organization)
			if err != nil {
				return fmt.Errorf("cannot build document data: %w", err)
			}
			...
			if obligationDocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *obligationDocumentID)
				if err != nil && !errors.Is(err, coredata.ErrResourceNotFound) {
			...
			if existingDoc == nil {
				...
				if err := obligation.UpsertGeneratedDocumentID(ctx, tx, organizationID, predicate.GetTenantID(), documentID); err != nil {
					return fmt.Errorf("cannot upsert generated documents: %w", err)
				}
			} else {
				document = existingDoc
...
func (s *GeneratedDocumentService) buildObligationListDocumentData(
	...
	if err := obligations.LoadAllByOrganizationID(ctx, conn, predicate, organization.ID); err != nil {
...
func (s *GeneratedDocumentService) PublishProcessingActivityList(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			documentData, err := s.buildProcessingActivityListDocumentData(ctx, predicate, tx, organization)
			if err != nil {
				return fmt.Errorf("cannot build document data: %w", err)
			}
			...
			if processingActivityDocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *processingActivityDocumentID)
				if err != nil && !errors.Is(err, coredata.ErrResourceNotFound) {
			...
			if existingDoc == nil {
				...
				if err := processingActivity.UpsertGeneratedDocumentID(ctx, tx, organizationID, predicate.GetTenantID(), documentID); err != nil {
					return fmt.Errorf("cannot upsert generated documents: %w", err)
				}
			} else {
				document = existingDoc
...
func (s *GeneratedDocumentService) buildProcessingActivityListDocumentData(
	...
	if err := processingActivities.LoadAllByOrganizationID(ctx, conn, predicate, organization.ID); err != nil {
	...
	thirdPartyMap, err := thirdParties.LoadAllByProcessingActivities(ctx, conn, predicate, organization.ID)
	if err != nil {
	...
	if len(dpoIDs) > 0 {
		var profiles coredata.MembershipProfiles
		if err := profiles.LoadByIDs(ctx, conn, predicate, dpoIDs); err != nil {
...
func (s *GeneratedDocumentService) PublishDataProtectionImpactAssessmentList(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			documentData, err := s.buildDataProtectionImpactAssessmentListDocumentData(ctx, predicate, tx, organization)
			if err != nil {
				return fmt.Errorf("cannot build document data: %w", err)
			}
			...
			if dpiaDocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *dpiaDocumentID)
				if err != nil && !errors.Is(err, coredata.ErrResourceNotFound) {
			...
			if existingDoc == nil {
				...
				if err := dpia.UpsertGeneratedDocumentID(ctx, tx, organizationID, predicate.GetTenantID(), documentID); err != nil {
					return fmt.Errorf("cannot upsert generated documents: %w", err)
				}
			} else {
				document = existingDoc
...
func (s *GeneratedDocumentService) buildDataProtectionImpactAssessmentListDocumentData(
	...
	if err := assessments.LoadAllByOrganizationID(ctx, conn, predicate, organization.ID); err != nil {
	...
	var processingActivities coredata.ProcessingActivities
	if err := processingActivities.LoadByIDs(ctx, conn, predicate, processingActivityIDs); err != nil {
...
func (s *GeneratedDocumentService) PublishTransferImpactAssessmentList(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			documentData, err := s.buildTransferImpactAssessmentListDocumentData(ctx, predicate, tx, organization)
			if err != nil {
				return fmt.Errorf("cannot build document data: %w", err)
			}
			...
			if tiaDocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *tiaDocumentID)
				if err != nil && !errors.Is(err, coredata.ErrResourceNotFound) {
			...
			if existingDoc == nil {
				...
				if err := tia.UpsertGeneratedDocumentID(ctx, tx, organizationID, predicate.GetTenantID(), documentID); err != nil {
					return fmt.Errorf("cannot upsert generated documents: %w", err)
				}
			} else {
				document = existingDoc
...
func (s *GeneratedDocumentService) PublishThirdPartyList(
	...
	err := s.svc.pg.WithConn(ctx, func(ctx context.Context, conn pg.Querier) error {
		...
		documentData, err = s.buildThirdPartyListDocumentData(ctx, predicate, conn, organization)
		if err != nil {
			return fmt.Errorf("cannot build document data: %w", err)
		}
	...
	err = s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			if thirdPartyDocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *thirdPartyDocumentID)
				if err != nil && !errors.Is(err, coredata.ErrResourceNotFound) {
			...
			if existingDoc == nil {
				...
				if err := thirdParty.UpsertGeneratedDocumentID(ctx, tx, organizationID, predicate.GetTenantID(), documentID); err != nil {
					return fmt.Errorf("cannot upsert generated documents: %w", err)
				}
			} else {
				document = existingDoc
...
func (s *GeneratedDocumentService) buildThirdPartyListDocumentData(
	...
	if err := allServices.LoadByThirdPartyIDs(ctx, conn, predicate, thirdPartyIDs); err != nil {
	...
	if err := allContacts.LoadByThirdPartyIDs(ctx, conn, predicate, thirdPartyIDs); err != nil {
	...
	if err := allAssessments.LoadByThirdPartyIDs(ctx, conn, predicate, thirdPartyIDs); err != nil {
	...
	if err := allReports.LoadByThirdPartyIDs(ctx, conn, predicate, thirdPartyIDs); err != nil {
	...
	if err := allBAAs.LoadByThirdPartyIDs(ctx, conn, predicate, thirdPartyIDs); err != nil {
	...
	if err := allDPAs.LoadByThirdPartyIDs(ctx, conn, predicate, thirdPartyIDs); err != nil {
...
func (s *GeneratedDocumentService) PublishRiskList(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			...
			documentData, err := s.buildRiskListDocumentData(ctx, predicate, tx, organization)
			if err != nil {
				return fmt.Errorf("cannot build document data: %w", err)
			}
			...
			if riskDocumentID != nil {
				...
				err = doc.LoadByID(ctx, tx, predicate, *riskDocumentID)
				if err != nil && !errors.Is(err, coredata.ErrResourceNotFound) {
			...
			if existingDoc == nil {
				...
				if err := risk.UpsertGeneratedDocumentID(ctx, tx, organizationID, predicate.GetTenantID(), documentID); err != nil {
					return fmt.Errorf("cannot upsert generated documents: %w", err)
				}
			} else {
				document = existingDoc
...
func (s *GeneratedDocumentService) buildRiskListDocumentData(
	...
	if err := risks.LoadAllByOrganizationID(ctx, conn, predicate, organization.ID); err != nil {
...
func (s *GeneratedDocumentService) publishOrRequestApproval(
	...
	err := previousVersion.LoadLatestVersion(ctx, tx, predicate, document.ID)
	switch {
	case err == nil:
	...
	if len(approverIDs) > 0 {
		...
		if err := defaultApprovers.MergeByDocumentID(ctx, tx, predicate, document.ID, organizationID, approverIDs); err != nil {
			return fmt.Errorf("cannot save default approvers: %w", err)
		}

		if _, err := s.svc.DocumentApprovals.RequestApprovalInTx(ctx, predicate, tx, document, version, approverIDs, nil); err != nil {
	...
	if !minor {
		if err := s.svc.Documents.cancelPreviousMajorSignatureRequestsInTx(ctx, predicate, tx, document.ID, version.Major); err != nil {
