...
func (s FindingService) Get(
	...
	err := s.svc.pg.WithConn(
		...
		func(ctx context.Context, conn pg.Querier) error {
			return finding.LoadByID(ctx, conn, predicate, findingID)
		},
	)
	if err != nil {
...
func (s *FindingService) Create(
	...
	finding := &coredata.Finding{
		ID:                 gid.New(predicate.GetTenantID(), coredata.FindingEntityType),
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, conn pg.Tx) error {
			...
			if err := finding.Insert(ctx, conn, predicate); err != nil {
...
func (s *FindingService) Update(
	...
	err := s.svc.pg.WithTx(
		ctx,
		func(ctx context.Context, conn pg.Tx) error {
			if err := finding.LoadByID(ctx, conn, predicate, req.ID); err != nil {
			...
			if err := finding.Update(ctx, conn, predicate); err != nil {
...
func (s FindingService) Delete(
	...
	return s.svc.pg.WithTx(
		...
		func(ctx context.Context, tx pg.Tx) error {
			err := finding.Delete(ctx, tx, predicate)
			if err != nil {
...
func (s FindingService) ListForOrganizationID(
	...
	err := s.svc.pg.WithConn(
		ctx,
		func(ctx context.Context, conn pg.Querier) error {
			err := findings.LoadByOrganizationID(ctx, conn, predicate, organizationID, cursor, filter)
			if err != nil {
...
func (s FindingService) CountForOrganizationID(
	...
	err := s.svc.pg.WithConn(
		...
		func(ctx context.Context, conn pg.Querier) (err error) {
			...
			count, err = findings.CountByOrganizationID(ctx, conn, predicate, organizationID, filter)
			if err != nil {
...
func (s FindingService) CreateAuditMapping(
	...
	err := s.svc.pg.WithConn(
		...
		func(ctx context.Context, conn pg.Querier) error {
			...
			if err := findingAudit.Upsert(ctx, conn, predicate); err != nil {
...
func (s FindingService) DeleteAuditMapping(
	...
	err := s.svc.pg.WithTx(
		ctx,
		func(ctx context.Context, tx pg.Tx) error {
			if err := finding.LoadByID(ctx, tx, predicate, findingID); err != nil {
				return fmt.Errorf("cannot load finding: %w", err)
			}
			...
			findingAudit := &coredata.FindingAudit{}
			if err := findingAudit.Delete(ctx, tx, predicate, finding.ID, audit.ID); err != nil {
...
func (s FindingService) ListForAuditID(
	...
	err := s.svc.pg.WithConn(
		...
		func(ctx context.Context, conn pg.Querier) error {
			...
			if err := findings.LoadByAuditID(ctx, conn, predicate, auditID, cursor, filter); err != nil {
				return fmt.Errorf("cannot load findings: %w", err)
			}
...
func (s FindingService) CountForAuditID(
	...
	err := s.svc.pg.WithConn(
		...
		func(ctx context.Context, conn pg.Querier) (err error) {
			...
			count, err = findings.CountByAuditID(ctx, conn, predicate, auditID, filter)
			if err != nil {
				return fmt.Errorf("cannot count findings: %w", err)
			}
