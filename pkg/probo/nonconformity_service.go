...
func (cnr *CreateNonconformityRequest) Validate() error {
	...
	v.Check(cnr.Description, "description", validator.NotEmpty(), validator.MaxLen(5000), validator.NoHTML(), validator.PrintableText())
	v.Check(cnr.AuditID, "audit_id", validator.Required(), validator.GID(coredata.AuditEntityType))
	v.Check(cnr.DateIdentified, "date_identified")
	...
	v.Check(cnr.CorrectiveAction, "corrective_action", validator.NotEmpty(), validator.MaxLen(5000), validator.NoHTML(), validator.PrintableText())
	v.Check(cnr.OwnerID, "owner_id", validator.Required(), validator.GID(coredata.PeopleEntityType))
	v.Check(cnr.DueDate, "due_date")
	v.Check(cnr.Status, "status", validator.OneOfSlice(coredata.NonconformityStatuses()))
	v.Check(cnr.EffectivenessCheck, "effectiveness_check", validator.NotEmpty(), validator.MaxLen(5000), validator.NoHTML(), validator.PrintableText())
...
func (unr *UpdateNonconformityRequest) Validate() error {
	...
	v.Check(unr.ReferenceID, "reference_id", validator.NotEmpty(), validator.MaxLen(100), validator.NoHTML(), validator.PrintableText())
	v.Check(unr.Description, "description", validator.NotEmpty(), validator.MaxLen(5000), validator.NoHTML(), validator.PrintableText())
	v.Check(unr.DateIdentified, "date_identified")
	v.Check(unr.RootCause, "root_cause", validator.NotEmpty(), validator.MaxLen(5000), validator.NoHTML(), validator.PrintableText())
	v.Check(unr.CorrectiveAction, "corrective_action", validator.NotEmpty(), validator.MaxLen(5000), validator.NoHTML(), validator.PrintableText())
	v.Check(unr.OwnerID, "owner_id", validator.GID(coredata.PeopleEntityType))
	v.Check(unr.DueDate, "due_date")
	v.Check(unr.Status, "status", validator.OneOfSlice(coredata.NonconformityStatuses()))
	v.Check(unr.EffectivenessCheck, "effectiveness_check", validator.NotEmpty(), validator.MaxLen(5000), validator.NoHTML(), validator.PrintableText())
