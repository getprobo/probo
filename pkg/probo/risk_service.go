...
func (crr *CreateRiskRequest) Validate() error {
	...
	v.Check(crr.Name, "name", validator.Required(), validator.NotEmpty(), validator.MaxLen(1000), validator.NoHTML(), validator.PrintableText())
	...
	v.Check(crr.Note, "note", validator.NotEmpty(), validator.MaxLen(1000), validator.NoHTML(), validator.PrintableText())
...
func (urr *UpdateRiskRequest) Validate() error {
	...
	v.Check(urr.Name, "name", validator.NotEmpty(), validator.MaxLen(1000), validator.NoHTML(), validator.PrintableText())
	v.Check(urr.Description, "description", validator.NotEmpty(), validator.MaxLen(5000), validator.NoHTML(), validator.PrintableText())
	v.Check(urr.Category, "category", validator.NotEmpty(), validator.NoHTML(), validator.PrintableText(), validator.MaxLen(1000))
	...
	v.Check(urr.Note, "note", validator.NotEmpty(), validator.MaxLen(1000), validator.NoHTML(), validator.PrintableText())
