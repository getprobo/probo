...
func (s TransferImpactAssessmentService) Get(
	...
	err := s.svc.pg.WithConn(
		...
		func(ctx context.Context, conn pg.Querier) error {
			if err := tia.LoadByID(ctx, conn, predicate, tiaID); err != nil {
...
func (s TransferImpactAssessmentService) GetByProcessingActivityID(
	...
	err := s.svc.pg.WithConn(
		ctx,
		func(ctx context.Context, conn pg.Querier) error {
			if err := tia.LoadByProcessingActivityID(ctx, conn, predicate, processingActivityID); err != nil {
				return fmt.Errorf("cannot load transfer impact assessment: %w", err)
			}
...
func (s TransferImpactAssessmentService) ListForOrganizationID(
	...
	err := s.svc.pg.WithConn(
		ctx,
		func(ctx context.Context, conn pg.Querier) error {
			err := tias.LoadByOrganizationID(ctx, conn, predicate, organizationID, cursor)
			if err != nil {
...
func (s TransferImpactAssessmentService) CountForOrganizationID(
	...
	err := s.svc.pg.WithConn(
		...
		func(ctx context.Context, conn pg.Querier) (err error) {
			...
			count, err = tias.CountByOrganizationID(ctx, conn, predicate, organizationID)
...
func (s *TransferImpactAssessmentService) Create(
	...
	tia := &coredata.TransferImpactAssessment{
		ID:                    gid.New(predicate.GetTenantID(), coredata.TransferImpactAssessmentEntityType),
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, conn pg.Tx) error {
			...
			if err := tia.Insert(ctx, conn, predicate); err != nil {
...
func (s *TransferImpactAssessmentService) Update(
	...
	err := s.svc.pg.WithTx(
		ctx,
		func(ctx context.Context, conn pg.Tx) error {
			if err := tia.LoadByID(ctx, conn, predicate, req.ID); err != nil {
				return fmt.Errorf("cannot load transfer impact assessment: %w", err)
			}
			...
			if err := tia.Update(ctx, conn, predicate); err != nil {
...
func (s *TransferImpactAssessmentService) Delete(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, conn pg.Tx) error {
			...
			if err := tia.Delete(ctx, conn, predicate); err != nil {
