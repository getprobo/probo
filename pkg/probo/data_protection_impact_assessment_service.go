...
func (s DataProtectionImpactAssessmentService) Get(
	...
	err := s.svc.pg.WithConn(
		...
		func(ctx context.Context, conn pg.Querier) error {
			if err := dpia.LoadByID(ctx, conn, predicate, dpiaID); err != nil {
...
func (s DataProtectionImpactAssessmentService) GetByProcessingActivityID(
	...
	err := s.svc.pg.WithConn(
		ctx,
		func(ctx context.Context, conn pg.Querier) error {
			if err := dpia.LoadByProcessingActivityID(ctx, conn, predicate, processingActivityID); err != nil {
				return fmt.Errorf("cannot load data protection impact assessment: %w", err)
			}
...
func (s DataProtectionImpactAssessmentService) ListForOrganizationID(
	...
	err := s.svc.pg.WithConn(
		ctx,
		func(ctx context.Context, conn pg.Querier) error {
			err := dpias.LoadByOrganizationID(ctx, conn, predicate, organizationID, cursor)
			if err != nil {
...
func (s DataProtectionImpactAssessmentService) CountForOrganizationID(
	...
	err := s.svc.pg.WithConn(
		...
		func(ctx context.Context, conn pg.Querier) (err error) {
			...
			count, err = dpias.CountByOrganizationID(ctx, conn, predicate, organizationID)
...
func (s *DataProtectionImpactAssessmentService) Create(
	...
	dpia := &coredata.DataProtectionImpactAssessment{
		ID:                          gid.New(predicate.GetTenantID(), coredata.DataProtectionImpactAssessmentEntityType),
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, conn pg.Tx) error {
			...
			if err := processingActivity.LoadByID(ctx, conn, predicate, req.ProcessingActivityID); err != nil {
				return fmt.Errorf("cannot load processing activity: %w", err)
			}

			dpia.OrganizationID = processingActivity.OrganizationID

			if err := dpia.Insert(ctx, conn, predicate); err != nil {
...
func (s *DataProtectionImpactAssessmentService) Update(
	...
	err := s.svc.pg.WithTx(
		ctx,
		func(ctx context.Context, conn pg.Tx) error {
			if err := dpia.LoadByID(ctx, conn, predicate, req.ID); err != nil {
				return fmt.Errorf("cannot load data protection impact assessment: %w", err)
			}
			...
			if err := dpia.Update(ctx, conn, predicate); err != nil {
...
func (s *DataProtectionImpactAssessmentService) Delete(
	...
	err := s.svc.pg.WithTx(
		...
		func(ctx context.Context, conn pg.Tx) error {
			...
			if err := dpia.Delete(ctx, conn, predicate); err != nil {
