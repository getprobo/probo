...
func (cor *CreateObligationRequest) Validate() error {
	...
	v.Check(cor.Area, "area", validator.NotEmpty(), validator.MaxLen(1000), validator.NoHTML(), validator.PrintableText())
	v.Check(cor.Source, "source", validator.NotEmpty(), validator.MaxLen(1000), validator.NoHTML(), validator.PrintableText())
	v.Check(cor.Requirement, "requirement", validator.NotEmpty(), validator.MaxLen(1000), validator.NoHTML(), validator.PrintableText())
	v.Check(cor.ActionsToBeImplemented, "actions_to_be_implemented", validator.NotEmpty(), validator.MaxLen(1000), validator.NoHTML(), validator.PrintableText())
	v.Check(cor.Regulator, "regulator", validator.NotEmpty(), validator.MaxLen(1000), validator.NoHTML(), validator.PrintableText())
	v.Check(cor.OwnerID, "owner_id", validator.Required(), validator.GID(coredata.PeopleEntityType))
	v.Check(cor.LastReviewDate, "last_review_date")
	v.Check(cor.DueDate, "due_date")
...
func (uor *UpdateObligationRequest) Validate() error {
	...
	v.Check(uor.Area, "area", validator.NotEmpty(), validator.MaxLen(100), validator.NoHTML(), validator.PrintableText())
	v.Check(uor.Source, "source", validator.NotEmpty(), validator.MaxLen(100), validator.NoHTML(), validator.PrintableText())
	v.Check(uor.Requirement, "requirement", validator.NotEmpty(), validator.MaxLen(100), validator.NoHTML(), validator.PrintableText())
	v.Check(uor.ActionsToBeImplemented, "actions_to_be_implemented", validator.NotEmpty(), validator.MaxLen(100), validator.NoHTML(), validator.PrintableText())
	v.Check(uor.Regulator, "regulator", validator.NotEmpty(), validator.MaxLen(100), validator.NoHTML(), validator.PrintableText())
	v.Check(uor.OwnerID, "owner_id", validator.GID(coredata.PeopleEntityType))
	v.Check(uor.LastReviewDate, "last_review_date")
	v.Check(uor.DueDate, "due_date")
