...
var (
	...
	AddNonconformityToolInputSchema                      = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"corrective_action":{"type":"string","description":"Corrective action"},"date_identified":{"type":"string","description":"Date identified","format":"date-time"},"description":{"type":"string","description":"Description"},"due_date":{"type":"string","description":"Due date","format":"date-time"},"effectiveness_check":{"type":"string","description":"Effectiveness check"},"organization_id":{"type":"string","format":"string"},"owner_id":{"type":"string","format":"string"},"reference_id":{"type":"string","description":"Reference ID"},"report_id":{"description":"Report ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No report"}]},"root_cause":{"type":"string","description":"Root cause"},"status":{"description":"Status","anyOf":[{"type":"string","enum":["OPEN","IN_PROGRESS","CLOSED"]},{"type":"null","description":"No status"}]}},"required":["organization_id","reference_id","root_cause","owner_id","status"]}`)
	AddNonconformityToolOutputSchema                     = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"nonconformity":{"type":"object","properties":{"corrective_action":{"type":["string","null"],"description":"Corrective action"},"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"date_identified":{"type":["string","null"],"description":"Date identified","format":"date-time"},"description":{"type":["string","null"],"description":"Description"},"due_date":{"type":["string","null"],"description":"Due date","format":"date-time"},"effectiveness_check":{"type":["string","null"],"description":"Effectiveness check"},"id":{"type":"string","format":"string"},"organization_id":{"type":"string","format":"string"},"owner_id":{"type":"string","format":"string"},"reference_id":{"type":"string","description":"Reference ID"},"report_id":{"description":"Report ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No report"}]},"root_cause":{"type":"string","description":"Root cause"},"snapshot_id":{"description":"Snapshot ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No snapshot"}]},"status":{"type":"string","enum":["OPEN","IN_PROGRESS","CLOSED"]},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"}},"required":["id","organization_id","reference_id","root_cause","owner_id","status","created_at","updated_at"]}},"required":["nonconformity"]}`)
	...
	AddReportToolInputSchema                             = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"framework_id":{"type":"string","format":"string"},"framework_type":{"type":"string","description":"Framework type"},"name":{"type":"string","description":"Report name"},"organization_id":{"type":"string","format":"string"},"state":{"type":"string","enum":["NOT_STARTED","IN_PROGRESS","COMPLETED","REJECTED","OUTDATED"]},"valid_from":{"type":"string","description":"Valid from date","format":"date-time"},"valid_until":{"type":"string","description":"Valid until date","format":"date-time"}},"required":["organization_id","framework_id"]}`)
	AddReportToolOutputSchema                            = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"report":{"type":"object","properties":{"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"framework_id":{"type":"string","format":"string"},"framework_type":{"type":["string","null"],"description":"Framework type"},"id":{"type":"string","format":"string"},"name":{"type":["string","null"],"description":"Report name"},"organization_id":{"type":"string","format":"string"},"state":{"type":"string","enum":["NOT_STARTED","IN_PROGRESS","COMPLETED","REJECTED","OUTDATED"]},"trust_center_visibility":{"type":"string","enum":["NONE","PRIVATE","PUBLIC"]},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"},"valid_from":{"type":["string","null"],"description":"Valid from date","format":"date-time"},"valid_until":{"type":["string","null"],"description":"Valid until date","format":"date-time"}},"required":["id","organization_id","framework_id","state","trust_center_visibility","created_at","updated_at"]}},"required":["report"]}`)
	...
	GetContinualImprovementToolOutputSchema              = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"continual_improvement":{"type":"object","properties":{"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"description":{"type":["string","null"],"description":"Description"},"id":{"type":"string","format":"string"},"organization_id":{"type":"string","format":"string"},"owner_id":{"type":"string","format":"string"},"priority":{"type":"string","enum":["LOW","MEDIUM","HIGH"]},"reference_id":{"type":"string","description":"Reference ID"},"snapshot_id":{"description":"Snapshot ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No snapshot"}]},"source":{"type":["string","null"],"description":"Source"},"source_id":{"type":["string","null"],"description":"Source ID"},"status":{"type":"string","enum":["OPEN","IN_PROGRESS","CLOSED"]},"target_date":{"type":["string","null"],"description":"Target date","format":"date-time"},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"}},"required":["id","organization_id","reference_id","owner_id","status","priority","created_at","updated_at"]}},"required":["continual_improvement"]}`)
	GetControlToolInputSchema                            = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"id":{"type":"string","format":"string"}},"required":["id"]}`)
	GetControlToolOutputSchema                           = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"control":{"type":"object","properties":{"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"description":{"type":["string","null"],"description":"Control description"},"framework_id":{"type":"string","format":"string"},"id":{"type":"string","format":"string"},"name":{"type":"string","description":"Control name"},"organization_id":{"type":"string","format":"string"},"section_title":{"type":"string","description":"Section title"},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"}},"required":["id","organization_id","framework_id","section_title","name","created_at","updated_at"]}},"required":["control"]}`)
	...
	GetNonconformityToolOutputSchema                     = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"nonconformity":{"type":"object","properties":{"corrective_action":{"type":["string","null"],"description":"Corrective action"},"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"date_identified":{"type":["string","null"],"description":"Date identified","format":"date-time"},"description":{"type":["string","null"],"description":"Description"},"due_date":{"type":["string","null"],"description":"Due date","format":"date-time"},"effectiveness_check":{"type":["string","null"],"description":"Effectiveness check"},"id":{"type":"string","format":"string"},"organization_id":{"type":"string","format":"string"},"owner_id":{"type":"string","format":"string"},"reference_id":{"type":"string","description":"Reference ID"},"report_id":{"description":"Report ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No report"}]},"root_cause":{"type":"string","description":"Root cause"},"snapshot_id":{"description":"Snapshot ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No snapshot"}]},"status":{"type":"string","enum":["OPEN","IN_PROGRESS","CLOSED"]},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"}},"required":["id","organization_id","reference_id","root_cause","owner_id","status","created_at","updated_at"]}},"required":["nonconformity"]}`)
	...
	GetReportToolInputSchema                             = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"id":{"type":"string","format":"string"}},"required":["id"]}`)
	GetReportToolOutputSchema                            = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"report":{"type":"object","properties":{"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"framework_id":{"type":"string","format":"string"},"framework_type":{"type":["string","null"],"description":"Framework type"},"id":{"type":"string","format":"string"},"name":{"type":["string","null"],"description":"Report name"},"organization_id":{"type":"string","format":"string"},"state":{"type":"string","enum":["NOT_STARTED","IN_PROGRESS","COMPLETED","REJECTED","OUTDATED"]},"trust_center_visibility":{"type":"string","enum":["NONE","PRIVATE","PUBLIC"]},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"},"valid_from":{"type":["string","null"],"description":"Valid from date","format":"date-time"},"valid_until":{"type":["string","null"],"description":"Valid until date","format":"date-time"}},"required":["id","organization_id","framework_id","state","trust_center_visibility","created_at","updated_at"]}},"required":["report"]}`)
	...
	LinkControlReportToolInputSchema                     = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"control_id":{"type":"string","format":"string"},"report_id":{"type":"string","format":"string"}},"required":["control_id","report_id"]}`)
	LinkControlReportToolOutputSchema                    = mcp.MustUnmarshalSchema(`{"type":"object"}`)
	...
	ListNonconformitiesToolOutputSchema                  = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"next_cursor":{"type":"string","format":"string"},"nonconformities":{"type":"array","items":{"type":"object","properties":{"corrective_action":{"type":["string","null"],"description":"Corrective action"},"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"date_identified":{"type":["string","null"],"description":"Date identified","format":"date-time"},"description":{"type":["string","null"],"description":"Description"},"due_date":{"type":["string","null"],"description":"Due date","format":"date-time"},"effectiveness_check":{"type":["string","null"],"description":"Effectiveness check"},"id":{"type":"string","format":"string"},"organization_id":{"type":"string","format":"string"},"owner_id":{"type":"string","format":"string"},"reference_id":{"type":"string","description":"Reference ID"},"report_id":{"description":"Report ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No report"}]},"root_cause":{"type":"string","description":"Root cause"},"snapshot_id":{"description":"Snapshot ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No snapshot"}]},"status":{"type":"string","enum":["OPEN","IN_PROGRESS","CLOSED"]},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"}},"required":["id","organization_id","reference_id","root_cause","owner_id","status","created_at","updated_at"]}}},"required":["nonconformities"]}`)
	...
	ListReportsToolInputSchema                           = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"cursor":{"type":"string","format":"string"},"order_by":{"type":"object","properties":{"direction":{"type":"string","enum":["ASC","DESC"]},"field":{"type":"string","enum":["CREATED_AT","VALID_FROM","VALID_UNTIL","STATE"]}},"required":["field","direction"]},"organization_id":{"type":"string","format":"string"},"size":{"type":"integer","description":"Page size"}},"required":["organization_id"]}`)
	ListReportsToolOutputSchema                          = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"next_cursor":{"type":"string","format":"string"},"reports":{"type":"array","items":{"type":"object","properties":{"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"framework_id":{"type":"string","format":"string"},"framework_type":{"type":["string","null"],"description":"Framework type"},"id":{"type":"string","format":"string"},"name":{"type":["string","null"],"description":"Report name"},"organization_id":{"type":"string","format":"string"},"state":{"type":"string","enum":["NOT_STARTED","IN_PROGRESS","COMPLETED","REJECTED","OUTDATED"]},"trust_center_visibility":{"type":"string","enum":["NONE","PRIVATE","PUBLIC"]},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"},"valid_from":{"type":["string","null"],"description":"Valid from date","format":"date-time"},"valid_until":{"type":["string","null"],"description":"Valid until date","format":"date-time"}},"required":["id","organization_id","framework_id","state","trust_center_visibility","created_at","updated_at"]}}},"required":["reports"]}`)
	...
	UnlinkControlReportToolInputSchema                   = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"control_id":{"type":"string","format":"string"},"report_id":{"type":"string","format":"string"}},"required":["control_id","report_id"]}`)
	UnlinkControlReportToolOutputSchema                  = mcp.MustUnmarshalSchema(`{"type":"object"}`)
	...
	UpdateContinualImprovementToolInputSchema            = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"description":{"type":["string","null"],"description":"Description"},"id":{"type":"string","format":"string"},"owner_id":{"description":"Owner ID","anyOf":[{"type":"string","format":"string"},{"type":"null"}]},"priority":{"description":"Priority","anyOf":[{"type":"string","enum":["LOW","MEDIUM","HIGH"]},{"type":"null","description":"No priority"}]},"reference_id":{"type":"string","description":"Reference ID"},"source":{"type":["string","null"],"description":"Source"},"status":{"description":"Status","anyOf":[{"type":"string","enum":["OPEN","IN_PROGRESS","CLOSED"]},{"type":"null","description":"No status"}]},"target_date":{"type":["string","null"],"description":"Target date","format":"date-time"}},"required":["id"]}`)
	UpdateContinualImprovementToolOutputSchema           = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"continual_improvement":{"type":"object","properties":{"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"description":{"type":["string","null"],"description":"Description"},"id":{"type":"string","format":"string"},"organization_id":{"type":"string","format":"string"},"owner_id":{"type":"string","format":"string"},"priority":{"type":"string","enum":["LOW","MEDIUM","HIGH"]},"reference_id":{"type":"string","description":"Reference ID"},"snapshot_id":{"description":"Snapshot ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No snapshot"}]},"source":{"type":["string","null"],"description":"Source"},"source_id":{"type":["string","null"],"description":"Source ID"},"status":{"type":"string","enum":["OPEN","IN_PROGRESS","CLOSED"]},"target_date":{"type":["string","null"],"description":"Target date","format":"date-time"},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"}},"required":["id","organization_id","reference_id","owner_id","status","priority","created_at","updated_at"]}},"required":["continual_improvement"]}`)
	UpdateControlToolInputSchema                         = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"description":{"type":["string","null"],"description":"Control description"},"id":{"type":"string","format":"string"},"name":{"type":"string","description":"Control name"},"section_title":{"type":"string","description":"Section title"}},"required":["id"]}`)
	UpdateControlToolOutputSchema                        = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"control":{"type":"object","properties":{"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"description":{"type":["string","null"],"description":"Control description"},"framework_id":{"type":"string","format":"string"},"id":{"type":"string","format":"string"},"name":{"type":"string","description":"Control name"},"organization_id":{"type":"string","format":"string"},"section_title":{"type":"string","description":"Section title"},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"}},"required":["id","organization_id","framework_id","section_title","name","created_at","updated_at"]}},"required":["control"]}`)
	...
	UpdateMeetingToolInputSchema                         = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"attendee_ids":{"type":"array","items":{"type":"string","format":"string"},"description":"List of attendee profile IDs"},"date":{"type":"string","description":"Meeting date","format":"date-time"},"id":{"type":"string","format":"string"},"minutes":{"type":["string","null"],"description":"Meeting minutes"},"name":{"type":"string","description":"Meeting name"}},"required":["id"]}`)
	...
	UpdateNonconformityToolInputSchema                   = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"corrective_action":{"type":["string","null"],"description":"Corrective action"},"date_identified":{"type":["string","null"],"description":"Date identified","format":"date-time"},"description":{"type":["string","null"],"description":"Description"},"due_date":{"type":["string","null"],"description":"Due date","format":"date-time"},"effectiveness_check":{"type":["string","null"],"description":"Effectiveness check"},"id":{"type":"string","format":"string"},"owner_id":{"description":"Owner ID","anyOf":[{"type":"string","format":"string"},{"type":"null"}]},"reference_id":{"type":"string","description":"Reference ID"},"report_id":{"description":"Report ID","anyOf":[{"type":"string","format":"string"},{"type":"null"}]},"root_cause":{"type":"string","description":"Root cause"},"status":{"type":"string","enum":["OPEN","IN_PROGRESS","CLOSED"]}},"required":["id"]}`)
	UpdateNonconformityToolOutputSchema                  = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"nonconformity":{"type":"object","properties":{"corrective_action":{"type":["string","null"],"description":"Corrective action"},"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"date_identified":{"type":["string","null"],"description":"Date identified","format":"date-time"},"description":{"type":["string","null"],"description":"Description"},"due_date":{"type":["string","null"],"description":"Due date","format":"date-time"},"effectiveness_check":{"type":["string","null"],"description":"Effectiveness check"},"id":{"type":"string","format":"string"},"organization_id":{"type":"string","format":"string"},"owner_id":{"type":"string","format":"string"},"reference_id":{"type":"string","description":"Reference ID"},"report_id":{"description":"Report ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No report"}]},"root_cause":{"type":"string","description":"Root cause"},"snapshot_id":{"description":"Snapshot ID","anyOf":[{"type":"string","format":"string"},{"type":"null","description":"No snapshot"}]},"status":{"type":"string","enum":["OPEN","IN_PROGRESS","CLOSED"]},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"}},"required":["id","organization_id","reference_id","root_cause","owner_id","status","created_at","updated_at"]}},"required":["nonconformity"]}`)
	...
	UpdateReportToolInputSchema                          = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"framework_type":{"type":["string","null"],"description":"Framework type"},"id":{"type":"string","format":"string"},"name":{"type":["string","null"],"description":"Report name"},"state":{"description":"Report state","anyOf":[{"type":"string","enum":["NOT_STARTED","IN_PROGRESS","COMPLETED","REJECTED","OUTDATED"]},{"type":"null","description":"No state"}]},"trust_center_visibility":{"description":"Trust center visibility","anyOf":[{"type":"string","enum":["NONE","PRIVATE","PUBLIC"]},{"type":"null","description":"No trust center visibility"}]},"valid_from":{"type":["string","null"],"description":"Valid from date","format":"date-time"},"valid_until":{"type":["string","null"],"description":"Valid until date","format":"date-time"}},"required":["id"]}`)
	UpdateReportToolOutputSchema                         = mcp.MustUnmarshalSchema(`{"type":"object","properties":{"report":{"type":"object","properties":{"created_at":{"type":"string","description":"Creation timestamp","format":"date-time"},"framework_id":{"type":"string","format":"string"},"framework_type":{"type":["string","null"],"description":"Framework type"},"id":{"type":"string","format":"string"},"name":{"type":["string","null"],"description":"Report name"},"organization_id":{"type":"string","format":"string"},"state":{"type":"string","enum":["NOT_STARTED","IN_PROGRESS","COMPLETED","REJECTED","OUTDATED"]},"trust_center_visibility":{"type":"string","enum":["NONE","PRIVATE","PUBLIC"]},"updated_at":{"type":"string","description":"Update timestamp","format":"date-time"},"valid_from":{"type":["string","null"],"description":"Valid from date","format":"date-time"},"valid_until":{"type":["string","null"],"description":"Valid until date","format":"date-time"}},"required":["id","organization_id","framework_id","state","trust_center_visibility","created_at","updated_at"]}},"required":["report"]}`)
...
type AddNonconformityInput struct {
	...
	ReferenceID string `json:"reference_id"`
	// Report ID
	ReportID *gid.GID `json:"report_id,omitempty"`
	// Root cause
...
// AddReportInput represents the schema
...
// AddReportOutput represents the schema
type AddReportOutput struct {
...
// GetReportInput represents the schema
type GetReportInput struct {
	// Report ID
	ID gid.GID `json:"id"`
}

// GetReportOutput represents the schema
...
// LinkControlReportInput represents the schema
type LinkControlReportInput struct {
	// Control ID
	ControlID gid.GID `json:"control_id"`
	// Report ID
	ReportID gid.GID `json:"report_id"`
}

// LinkControlReportOutput represents the schema
type LinkControlReportOutput struct {
}
...
type ListDataProtectionImpactAssessmentsInput struct {
	Cursor         *page.CursorKey                                 `json:"cursor,omitempty"`
	Filter         *ListDataProtectionImpactAssessmentsInputFilter `json:"filter,omitempty"`
...
type ListProcessingActivitiesInput struct {
	// Page cursor
	Cursor *page.CursorKey                      `json:"cursor,omitempty"`
	Filter *ListProcessingActivitiesInputFilter `json:"filter,omitempty"`
	// Order by
...
// ListReportsInput represents the schema
...
// ListReportsOutput represents the schema
...
type ListTransferImpactAssessmentsInput struct {
	Cursor         *page.CursorKey                           `json:"cursor,omitempty"`
	Filter         *ListTransferImpactAssessmentsInputFilter `json:"filter,omitempty"`
...
// ReportOrderBy represents the schema
type ReportOrderBy struct {
	// Report order direction
	Direction page.OrderDirection `json:"direction"`
	// Report order field
	Field coredata.ReportOrderField `json:"field"`
}
...
// UnlinkControlReportInput represents the schema
type UnlinkControlReportInput struct {
	// Control ID
	ControlID gid.GID `json:"control_id"`
	// Report ID
	ReportID gid.GID `json:"report_id"`
...
// UnlinkControlReportOutput represents the schema
type UnlinkControlReportOutput struct {
}
...
type UpdateNonconformityInput struct {
	...
	ReferenceID *string `json:"reference_id,omitempty"`
	// Report ID
	ReportID mcp.Omittable[*gid.GID] `json:"report_id,omitempty"`
	// Root cause
...
// UpdateReportInput represents the schema
type UpdateReportInput struct {
	// Framework type
	FrameworkType mcp.Omittable[*string] `json:"framework_type,omitempty"`
	// Report ID
	ID gid.GID `json:"id"`
	// Report name
...
// UpdateReportOutput represents the schema
