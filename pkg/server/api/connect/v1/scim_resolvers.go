...
type (
	...
	sCIMBridgeResolver          struct{ *Resolver }
	sCIMConfigurationResolver   struct{ *Resolver }
	sCIMEventResolver           struct{ *Resolver }
	sCIMEventConnectionResolver struct{ *Resolver }
)
