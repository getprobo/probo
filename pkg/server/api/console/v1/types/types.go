...
type UpdateRightsRequestInput struct {
	ID           gid.GID                                         `json:"id"`
	RequestType  graphql.Omittable[*coredata.RightsRequestType]  `json:"requestType,omitempty"`
	RequestState graphql.Omittable[*coredata.RightsRequestState] `json:"requestState,omitempty"`
