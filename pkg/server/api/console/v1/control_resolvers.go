...
type (
	applicabilityStatementResolver             struct{ *Resolver }
	applicabilityStatementConnectionResolver   struct{ *Resolver }
	controlResolver                            struct{ *Resolver }
	controlConnectionResolver                  struct{ *Resolver }
	statementOfApplicabilityResolver           struct{ *Resolver }
	statementOfApplicabilityConnectionResolver struct{ *Resolver }
)
