...
func (r *organizationResolver) TreatmentPlans(ctx context.Context, obj *types.Organization, first *int, after *page.CursorKey, last *int, before *page.CursorKey, orderBy *types.TreatmentPlanOrderBy) (*types.TreatmentPlanConnection, error) {
	...
	p, err := r.riskManagement.ListTreatmentPlansForOrganizationID(ctx, scope, obj.ID, cursor)
	if err != nil {
