...
type (
	dataProtectionImpactAssessmentResolver           struct{ *Resolver }
	dataProtectionImpactAssessmentConnectionResolver struct{ *Resolver }
	transferImpactAssessmentResolver                 struct{ *Resolver }
	transferImpactAssessmentConnectionResolver       struct{ *Resolver }
)
