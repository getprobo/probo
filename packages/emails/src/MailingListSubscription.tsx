  ...
  return (
    ...
    >
      <Text style={bodyText}>
        ...
        <strong>{"{{.OrganizationName}}"}</strong>. Please confirm your
        subscription to start receiving notifications whenever new information
        is published on their compliance page.
      </Text>
