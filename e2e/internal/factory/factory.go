...
func (b *StatementOfApplicabilityBuilder) WithDefaultApproverIDs(ids []string) *StatementOfApplicabilityBuilder {
	b.defaultApprovers = ids
	return b
}
...
func (b *StatementOfApplicabilityBuilder) Create() string {
	...
	if len(b.defaultApprovers) > 0 {
		input["defaultApproverIds"] = b.defaultApprovers
	}
