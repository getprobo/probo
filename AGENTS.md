...
- [`contrib/claude/cloudaccount.md`](contrib/claude/cloudaccount.md) — Cloud accounts (multi-cloud connector for AWS / GCP / Azure: credential model, install flows, probe lifecycle, field-level RBAC)
