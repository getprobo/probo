/**
 * @generated SignedSource<<68a9bf1ac8eb4b872dc419b2f8c1e518>>
...
export type ReportsPageQuery$variables = {
  organizationId: string;
};
export type ReportsPageQuery$data = {
  readonly node: {
...
export type ReportsPageQuery = {
  response: ReportsPageQuery$data;
  variables: ReportsPageQuery$variables;
};
...
v2 = {
  "alias": "canCreateReport",
  "args": [
    {
      "kind": "Literal",
      "name": "action",
      "value": "core:report:create"
    }
  ],
  "kind": "ScalarField",
  "name": "permission",
  "storageKey": "permission(action:\"core:report:create\")"
},
v3 = {
  "alias": null,
  "args": null,
