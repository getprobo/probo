...
export type CompliancePageNewsListQuery$variables = {
  after?: string | null | undefined;
  first?: number | null | undefined;
  id: string;
};
export type CompliancePageNewsListQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"CompliancePageNewsListFragment">;
  };
};
export type CompliancePageNewsListQuery = {
  response: CompliancePageNewsListQuery$data;
  variables: CompliancePageNewsListQuery$variables;
};
