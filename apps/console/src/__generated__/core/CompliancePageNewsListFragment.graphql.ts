...
export type CompliancePageNewsListFragment$key = {
  readonly " $data"?: CompliancePageNewsListFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"CompliancePageNewsListFragment">;
};

import CompliancePageNewsListQuery_graphql from './CompliancePageNewsListQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": CompliancePageNewsListQuery_graphql,
      "identifierInfo": {
        "identifierField": "id",
