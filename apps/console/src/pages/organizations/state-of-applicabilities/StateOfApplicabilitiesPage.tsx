...
type StateOfApplicability = NodeOf<
  StateOfApplicabilityGraphPaginatedFragment$data["stateOfApplicabilities"]
>;

export default function StateOfApplicabilitiesPage({
  queryRef,
}: {
  ...
  return (
    <div className="space-y-6">
      ...
      {stateOfApplicabilities && stateOfApplicabilities.length > 0 ? (
        <Card>
          <Table>
            <Thead>
              <Tr>
            ...
            <Tbody>
              {stateOfApplicabilities.map((soa) => (
...
function StateOfApplicabilityRow({
  ...
  return (
    <Tr to={detailUrl}>
      ...
      <Td>{stateOfApplicability.description || "-"}</Td>
      <Td>
