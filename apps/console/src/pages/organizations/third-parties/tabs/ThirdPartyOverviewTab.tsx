...
export default function ThirdPartyOverviewTab() {
  ...
  const isFormDisabled = isSubmitting || isSnapshotMode || !thirdParty.canUpdate;

  return (
    <form
      onSubmit={isSnapshotMode || !thirdParty.canUpdate
        ? undefined
    ...
    >
      ...
      <div className="space-y-4">
        <h2 className="text-base font-medium">{__("ThirdParty details")}</h2>
