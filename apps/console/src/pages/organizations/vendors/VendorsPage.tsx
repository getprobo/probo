...
export default function VendorsPage(props: Props) {
  ...
  const hasAnyAction = !isSnapshotMode && (
    isAuthorized(organizationId, "Vendor", "update") ||
    isAuthorized(organizationId, "Vendor", "delete")
  );
  ...
  return (
    <div className="space-y-6">
      ...
      >
        {!isSnapshotMode && (
          <IfAuthorized entity="Vendor" action="create">
            <CreateVendorDialog
      ...
      <Tr to={vendorUrl}>
        ...
        {hasAnyAction && (
          <Td noLink width={50} className="text-end">
            <ActionDropdown>
              <IfAuthorized entity="Vendor" action="delete">
                <DropdownItem
