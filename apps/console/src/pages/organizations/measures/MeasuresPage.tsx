...
export default function MeasuresPage(props: Props) {
  ...
  const hasAnyAction = isAuthorized(organization.id, "Measure", "update") ||
    isAuthorized(organization.id, "Measure", "delete");
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <IfAuthorized entity="Measure" action="create">
          <FileButton
            ref={importFileRef}
            variant="secondary"
      ...
      <Tr to={`/organizations/${organizationId}/measures/${props.measure.id}`}>
        ...
        {props.hasAnyAction && (
          <Td noLink width={50} className="text-end">
            <ActionDropdown>
              <IfAuthorized entity="Measure" action="update">
                <DropdownItem
                  icon={IconPencil}
              ...
              <IfAuthorized entity="Measure" action="delete">
                <DropdownItem
                  onClick={onDelete}
                  disabled={isDeleting}
                  variant="danger"
