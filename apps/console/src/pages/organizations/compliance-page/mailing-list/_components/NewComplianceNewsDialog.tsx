...
import type { NewComplianceNewsDialogMutation } from "#/__generated__/core/NewComplianceNewsDialogMutation.graphql";
...
export function NewComplianceNewsDialog(props: {
  ...
  const [createNews, isCreating] = useMutationWithToasts<NewComplianceNewsDialogMutation>(
    createMutation,
    {
      successMessage: __("News created successfully"),
      errorMessage: __("Failed to create news"),
    },
  );
  ...
  return (
    <Dialog ref={ref} title={__("Add News")}>
