...
export default function ProcessingActivitiesPage({ queryRef }: ProcessingActivitiesPageProps) {
  ...
  const hasAnyAction = !isSnapshotMode && (
    isAuthorized(organizationId, "ProcessingActivity", "update") ||
    isAuthorized(organizationId, "ProcessingActivity", "delete")
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader title={__("Processing Activities")} description={__("Manage your processing activities under GDPR")}>
        {!isSnapshotMode && (
          <IfAuthorized entity="ProcessingActivity" action="create">
    ...
    <Tr to={activityUrl}>
      ...
      {hasAnyAction && (
        <Td noLink width={50} className="text-end">
          <ActionDropdown>
            <IfAuthorized entity="ProcessingActivity" action="delete">
              <DropdownItem
                icon={IconTrashCan}
                variant="danger"
