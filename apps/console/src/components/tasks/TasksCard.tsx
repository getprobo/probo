...
export default function TasksCard({ tasks, connectionId }: Props) {
  ...
  const hasAnyAction = isAuthorized(organizationId, "Task", "update") ||
    isAuthorized(organizationId, "Task", "delete");
    ...
    <>
      ...
      <div className="flex items-center justify-between py-3 px-6">
        ...
        <div className="flex gap-2 items-center">
          ...
          {props.hasAnyAction && (
            <ActionDropdown>
              <IfAuthorized entity="Task" action="update">
                <DropdownItem
                  icon={IconPencil}
              ...
              <IfAuthorized entity="Task" action="delete">
                <DropdownItem
                  variant="danger"
                  icon={IconTrashCan}
                  onClick={onDelete}
