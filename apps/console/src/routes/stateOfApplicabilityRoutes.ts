...
export const stateOfApplicabilityRoutes = [
  {
    ...
    Component: withQueryRef(
      lazy(() => import("/pages/organizations/state-of-applicabilities/StateOfApplicabilitiesPage")),
    ),
  },
  {
  ...
  },
  {
    ...
    Component: withQueryRef(
      lazy(() => import("/pages/organizations/state-of-applicabilities/StateOfApplicabilityDetailPage")),
    ),
  },
  {
